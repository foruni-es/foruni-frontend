...
const LandingPage = () => {
    ...
    return (
        <main className="mx-auto max-w-7xl pt-32 px-2 mt-5 lg:mt-20 xl:mt-8 2xl:mt-32">
            <div className="text-center">
                ...
                <p className="mx-auto mt-3 max-w-md text-base text-gray-500 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl">
                    Descubre una manera más ágil y colaborativa de comunicarte con los miembros de tu universidad (y de otras universidades de toda España)
                </p>
