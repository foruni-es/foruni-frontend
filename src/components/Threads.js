                          ...
                          <div>
                              ...
                              <div className="min-w-0 flex-1">
                                  <p className="text-sm font-medium text-gray-900">
                                    <a href="#">
                                        Por {thread.authorName}, hace {elapsedTime(thread.publicationDatetime)}
                                    </a>
                                  </p>
                                  <p className="text-sm font-medium text-gray-900">
                                    <a href="#">
                                        <CheckBadgeIcon className="h-5 w-5 inline-block text-blue-600" aria-hidden="true" /> Creador de foruni
                                    </a>
                                  </p>
                                  <Link href={`/${thread.authorUniURL}`} className="text-sm text-gray-500 hover:underline">
                                    De la {thread.authorUni}
                                  </Link>
                              </div>
                              </div>
